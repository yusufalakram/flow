...
def get_circle_centers(lower, upper, radius):
    ...
    while lower[1] < upper[1]:
        ...
        """
        # this uses the radius appropriatly, but is missing 1 row at the y axis
            tmp += ((radius / 1000) / r) * (180 / math.pi)
        lower[1] += ((radius / 1000) / r) * (180 / math.pi) / math.cos(lower[00] * math.pi / 180)
...
def get_current_popularity(place_identifier):
    ...
    popular_times, rating, rating_n, current_popularity = None, None, None, -1
